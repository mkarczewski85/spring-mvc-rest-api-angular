package com.karczewski.manager.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.karczewski.manager.repositories",
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "com.karczewski.manager.model" });
